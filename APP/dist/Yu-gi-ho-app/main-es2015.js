...
/* harmony import */ var _envelopesfilter_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../envelopesfilter.pipe */ 5437);
...
function CardlistComponent_table_14_tr_17_td_7_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("input", function CardlistComponent_table_14_tr_17_td_7_Template_select_input_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r10); const i_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().index; const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](2); return (ctx_r9.carte.quantity[i_r5] = $event.target.value); });
...
function CardlistComponent_table_14_tr_17_td_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](1, "select", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("input", function CardlistComponent_table_14_tr_17_td_8_Template_select_input_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r16); const i_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().index; const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](2); return (ctx_r15.carte.typedeck[i_r5] = $event.target.value); });
...
function CardlistComponent_table_14_tr_17_td_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function CardlistComponent_table_14_tr_17_td_9_Template_button_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r21); const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](); const card_r4 = ctx_r20.$implicit; const i_r5 = ctx_r20.index; const ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](2); return ctx_r19.carte.AddToDeck(card_r4, i_r5); });
...
function CardlistComponent_table_14_tr_17_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function CardlistComponent_table_14_tr_17_Template_button_click_11_listener() { const restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r23); const card_r4 = restoredCtx.$implicit; const ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](2); return ctx_r22.showCardDetail(card_r4); });
...
CardlistComponent.ɵfac = function CardlistComponent_Factory(t) { return new (t || CardlistComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_dati_service__WEBPACK_IMPORTED_MODULE_0__.DatiService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_dati_service__WEBPACK_IMPORTED_MODULE_0__.DatiService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_auth_service__WEBPACK_IMPORTED_MODULE_1__.AuthService)); };
CardlistComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: CardlistComponent, selectors: [["app-cardlist"]], decls: 36, vars: 3, consts: [[1, "container-fluid"], [1, "container"], [1, "pagetitle"], [2, "font-family", "yu-gi-ho"], [1, "row"], [1, "col"], ["name", "profile", 1, "browser-default", "custom-select", 3, "value", "input"], ["selected", ""], [3, "value", 4, "ngFor", "ngForOf"], ["class", "table table-sm table-dark", 4, "ngIf"], ["id", "pagedescription"], ["color", "white"], [3, "value"], [1, "table", "table-sm", "table-dark"], ["id", "tabletitle"], [4, "ngFor", "ngForOf"], [3, "src"], [4, "ngIf"], ["type", "button", "name", "detailbutton", 3, "click"], ["name", "profile", 3, "value", "input"], ["value", "1"], ["value", "2"], ["value", "3"], ["value", "main", 4, "ngIf"], ["value", "extra", 4, "ngIf"], ["value", "side"], ["value", "main"], ["value", "extra"], ["type", "button", "name", "card", 3, "click"]], template: function CardlistComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("input", function CardlistComponent_Template_select_input_7_listener($event) { return ctx.setPack($event.target.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](35, "ricordati che secondo le regole ufficiali ogni deck pu\u00F2 avere massimo tre copie per di ogni carta ad eccezione delle carte proibite, limitate e semi limitate.");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
...
class DatiService {
    ...
    AddToDeck(card, index) {
        ...
        let url = "http://localhost:8000/users/" + localStorage.getItem("token_decoded_userid") + "/cards/" + this.card.cod + "/type/" + this.carta_selezionata.type;
        let url2 = "http://localhost:8000/users/" + localStorage.getItem("token_decoded_userid") + "/cards/" + this.card.cod;
        let url3 = "http://localhost:8000/users/" + localStorage.getItem("token_decoded_userid") + "/cards/" + this.card.cod + "/type/" + this.carta_selezionata.type;
    ...
    getCard(codice) {
        let url = "http://localhost:8000/singlecard/" + codice;
        this.http.get(url).subscribe((data) => {
    ...
    deleteCardfromdeck(card, index) {
        this.dati_carte_utente["cards"].splice(index, 1);
        this.card = card;
        let url = "http://localhost:8000/users/" + localStorage.getItem("token_decoded_userid") + "/cards/" + this.card.cod + "/type/" + this.card.type;
        this.http.delete(url).subscribe((data) => {
            console.info("Rimozione effetuata con successo");
        });
    }
    CardsLoggedUser() {
        let url = "http://localhost:8000/users/" + localStorage.getItem("token_decoded_userid") + "/cards";
    ...
    ;
    ListofEnvelopes() {
        let url = "http://localhost:8000/envelope/all";
        this.http.get(url).subscribe((data) => {
    ...
    AddEnvelope() {
        let url = "http://localhost:8000/envelope";
        let envelope = {};
    ...
    AddCardToEnvelope() {
        let url = "http://localhost:8000/cards/" + this.inputcodcard + "/envelope/" + this.inputcodenvelope;
        this.http.post(url, url).subscribe((data) => { });
        alert("Relazione aggiunta con successo!");
    }
}
DatiService.ɵfac = function DatiService_Factory(t) { return new (t || DatiService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_auth_service__WEBPACK_IMPORTED_MODULE_0__.AuthService)); };
DatiService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: DatiService, factory: DatiService.ɵfac, providedIn: 'root' });
...
class RecipesService {
    ...
    Addrecipes(name, desc) {
        ...
        let url = "http://localhost:8000/ricetta/user/" + localStorage.getItem("token_decoded_userid");
        let recipe = {};
        recipe["nomeric"] = name;
        recipe["desc"] = desc;
    ...
    Getrecipe(id) {
        let url = "http://localhost:8000/ricetta/" + id;
        this.http.get(url).subscribe((data) => {
            this.singleric = data;
        });
    ...
    Getrecipesidofuser() {
        let url = "http://localhost:8000/recipes/" + localStorage.getItem("token_decoded_userid") + "/user";
        this.http.get(url).subscribe((data) => {
            this.recipesid = data;
        });
    ...
    Addcomment(id, desc) {
        let url = "http://localhost:8000/comments/user/" + localStorage.getItem("token_decoded_userid") + "/ricetta/" + id;
        let comment = {};
        comment["desc"] = desc;
        this.user_comment = {
    ...
    Getrecipescomments(id) {
        let url = "http://localhost:8000/comments/recipe/" + id;
        this.http.get(url).subscribe((data) => {
            this.all_comment = data;
        });
    }
    Getrecipescommentsids(id, iduser) {
        let url = "http://localhost:8000/comments/recipe/" + id + "/user/" + iduser;
        this.http.get(url).subscribe((data) => {
    ...
    DeleteRecipe(idrecipe, index) {
        ...
        let url = "http://localhost:8000/recipe/" + idrecipe;
        this.http.delete(url).subscribe((data) => {
            console.log(data);
        });
    }
    DeleteComment(idcomment, index) {
        ...
        let url = "http://localhost:8000/comment/" + idcomment;
        this.http.delete(url).subscribe((data) => {
            console.log(data);
        });
    }
...
RecipesService.ɵprov = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: RecipesService, factory: RecipesService.ɵfac, providedIn: 'root' });
